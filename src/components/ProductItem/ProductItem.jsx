...
function ProductItem(props) {
  ...
  const handleProductItemClick = () => {
    if (selectedCount === props.totalCount) {
      return;
    }
        ...
        <ul className={styles.tagContainer}>
          ...
          <li className={styles.tag}>
            <img
              ...
              src="/images/IMEI_icon.svg"
              alt="Иконка IMEI"
            />
            Нужно сканировать IMEI
          </li>
        </ul>
      </div>
      <span
        ...
        style={
          props.totalCount === selectedCount ? counterBackgroundStyle : null
        }
      >
        {props.totalCount === selectedCount
          ? `${props.totalCount} шт.`
          : `${selectedCount} из ${props.totalCount} шт.`}
      </span>
